...
(42, 'Singaporean Hokkien Fried Mee', 20, 5, '32 - 1 kg pkgs.', 14.0, 26, 0, 0, True),
...
(46, 'Spegesild', 21, 8, '4 - 450 g glasses', 12.0, 95, 0, 0, False),
...
(51, 'Manjimup Dried Apples', 24, 7, '50 - 300 g pkgs.', 53.0, 20, 0, 10, False),
(52, 'Filo Mix', 24, 5, '16 - 2 kg boxes', 7.0, 38, 0, 25, False),
...
(56, 'Gnocchi di nonna Alice', 26, 5, '24 - 250 g pkgs.', 38.0, 21, 10, 30, False),
...
(66, 'Louisiana Hot Spiced Okra', 2, 2, '24 - 8 oz jars', 17.0, 4, 100, 20, False),
(67, 'Laughing Lumberjack Lager', 16, 1, '24 - 12 oz bottles', 14.0, 52, 0, 10, False),
(68, 'Scottish Longbreads', 8, 3, '10 boxes x 8 pieces', 12.5, 6, 10, 15, False),
(69, 'Gudbrandsdalsost', 15, 4, '10 kg pkg.', 36.0, 26, 0, 15, False),
(70, 'Outback Lager', 7, 1, '24 - 355 ml bottles', 15.0, 15, 10, 30, False),
(71, 'Flotemysost', 15, 4, '10 - 500 g pkgs.', 21.5, 26, 0, 0, False),
(72, 'Mozzarella di Giovanni', 14, 4, '24 - 200 g pkgs.', 34.8, 14, 0, 0, False),
(73, 'Röd Kaviar', 17, 8, '24 - 150 g jars', 15.0, 101, 0, 5, False),
(74, 'Longlife Tofu', 4, 7, '5 kg pkg.', 10.0, 4, 20, 5, False),
(75, 'Rhönbräu Klosterbier', 12, 1, '24 - 0.5 l bottles', 7.75, 125, 0, 25, False),
(76, 'Lakkalikööri', 23, 1, '500 ml', 18.0, 57, 0, 20, False),
(77, 'Original Frankfurter grüne Soße', 12, 2, '12 boxes', 13.0, 32, 0, 15, False);